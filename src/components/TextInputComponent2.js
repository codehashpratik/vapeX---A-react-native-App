...
const TextInputComponent2 = props => {
  ...
  return (
    <View
      style={{
        backgroundColor: 'rgba(171, 178, 185, 0.0)',
        width: props?.width,
        alignSelf: 'center',
        height: props?.height,
      ...
      <Text
        style={{
          ...
          color: isFocus ? props?.tintColor : Colors.white,
      ...
      <View
        style={{
          ...
          backgroundColor: 'rgba(171, 178, 185, 0.5)',
          flexDirection: 'row',
...
TextInputComponent2.defaultProps = {
  paddingH: 10,
  title: 'Title',
